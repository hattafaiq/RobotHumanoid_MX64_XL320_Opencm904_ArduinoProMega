...
void loop() {
  delay(2000);
  int sudut=servoxlRead(ID); //cecking servo pada sistem dengan jumlah total servo 12
  SerialUSB.print ("ID : "); SerialUSB.print(ID); 
  SerialUSB.print (" Pos : ");SerialUSB.println(sudut);
